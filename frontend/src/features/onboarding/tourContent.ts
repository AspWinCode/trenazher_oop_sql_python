...
print("Обратный:", reversed_string)`,
  ...
  wrongExplanation: 'Первый символ строки нужно получать через <strong>s[0]</strong>, а не <strong>s[1]</strong> — индексация начинается с нуля.',
  hintExplanation: 'Индексы строк начинаются с 0, поэтому первый символ — это <strong>s[0]</strong>.',
  canAutoSolve: true,
};
...
LIMIT 5`,
    ...
    wrongExplanation: 'Результат не прошёл проверку — сравните <strong>вывод вашего запроса</strong> с <strong>ожидаемым эталоном</strong> ниже и найдите отличие.',
